...
public class Grafica < T > implements Coleccion < T > {
    ...
    public void conecta(T a, T b, double peso) {
        ...
        u.vecinos.agrega(b, B);
        v.vecinos.agrega(a, A);
        aristas++;
    ...
    public void desconecta(T a, T b) {
        ...
        Vecino vu = u.vecinos.get(b);
        Vecino vv = v.vecinos.get(a);
        u.vecinos.elimina(b);
        v.vecinos.elimina(a);
        aristas--;
    }
    ...
    @Override public boolean contiene(T elemento) {
        return this.vertices.contiene(elemento);
    }
    ...
    @Override public void elimina(T elemento) {
        Vertice aEliminar = busca(elemento);
        if (vertices.contiene(elemento)) {
            vertices.elimina(elemento);
            for (Vertice s: vertices)
                if (s.vecinos.contiene(elemento)) {
                    s.vecinos.elimina(elemento);
                    aristas--;
                }
        }
    }
    ...
    public double getPeso(T a, T b) {
        ...
        Vertice v = busca(a);
        Vertice u = busca(b);
        if (u.vecinos.contiene(a))
            return u.vecinos.get(a).peso;
        return -1;
    }
    ...
    public void setPeso(T a, T b, double peso) {
        ...
        Vertice v = busca(a);
        Vertice u = busca(b);
        u.vecinos.get(a).peso = peso;
        v.vecinos.get(b).peso = peso;
    }
...
//Metodo auxiliar me regresa una lista de vertices
    private Lista< Vertice > Lista() {
        Lista < Vertice > q = new Lista < Vertice > ();
    ...
    public Lista < VerticeGrafica < T >> dijkstra(T origen, T destino) {
        ...
        s.distancia = 0;
        MonticuloMinimo < Vertice > monticulo = new MonticuloMinimo<Vertice>(Lista());
